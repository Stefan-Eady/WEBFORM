...
<body>
    <form id="form1" runat="server">
        <div style="height: 611px; width: 812px">
            <asp:Button ID="Button2" runat="server" style="z-index: 1; left: 336px; top: 235px; position: absolute; margin-bottom: 0px; width: 200px;" Text="Login" />
            <asp:Button ID="Button1" runat="server" style="position: relative; top: 290px; left: 323px; width: 194px;" Text="Apply" />
            <asp:Button ID="Button3" runat="server" style="z-index: 1; left: 329px; top: 380px; position: absolute; width: 195px;" Text="Contact" />
